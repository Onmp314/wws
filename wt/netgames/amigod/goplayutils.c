...
intBoard claim, bord, ndbord, threatBord, connectMap, groupIDs, protPoints;
short maxGroupID, depthLimit, killFlag, utilPlayLevel, treeLibLim;
short adjInAtari, adj2Libs, playMark, dbStop;
short gMap[maxGroup], sGlist[maxGroup + 1];
...
static short newGID, tryLevel, grpMark;
static short marker, numCapt;
static short inGenState;
static intBoard extra, sGroups, markBoard;
static boolBoard groupSeen;
static intList nlcGroup, aList;
static playRec playStack[1025];

static void copyArray (intBoard, intBoard);
static void initState (void);
static void stake (void);
static void spread (void);
static void respreicen (void);
static void genConnects (void);


#if 0	/* done in amigo.c */

static void initBoolBoard (boolBoard);
static void saveState (void);

void initBoolBoard (bb)
     boolBoard bb;
{				/* initBoolBoard */
  short i, j;
#ifdef DEBUG
...
static void spanGroupspan (x, y, libs, lookFor)
     short x, y, lookFor;
     pointList *libs;
{				/* span */
...
static void sSpanGroupspan (x, y, libs, lookFor)
     short x, y, lookFor;
     sPointList *libs;
{				/* span */
  markBoard[x][y] = marker;
...
static void LAspan (x, y, me, him, iL)
     short x, y, me, him;
     intList *iL;
{				/* span */
#ifdef DEBUG
...
static void listAdjacents (x, y, iL)
     short x, y;
     intList *iL;
{				/* listAdjacents */
  short me, him;
...
static void LDspan (x, y, me, diags)
     short x, y, me;
     sPointList *diags;
{				/* span */
#ifdef DEBUG
...
*/
static void Resspan (x, y, gID, gSize, libCount, who)
...
*/
static void killGroup (x, y, me, him)
     short x, y, me, him;
{				/* killGroup */
#ifdef DEBUG
  printf ("killGroup\n");
...
static void mergeGroup (sGID, myGID)
     short sGID, myGID;
{				/* mergeGroup */
  short i;
#ifdef DEBUG
...
{				/* undoTo */
  ...
  for (i = playMark; i >= uMark + 1; i--)
    ...
    else if (playStack[i].kind == add)
    {
      ...
      /* change libs of group - gID is pre-mapped */
    {
...
*/
static void MLspan (x, y, saw1, sawm1, size, sMark)
...
static short CLspan (x, y, numEyes, who)
...
#if 0	/* nothing uses this function...? */

static short tencen (short, short);
