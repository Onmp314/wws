/*
 * This code contains minor W window system specific changes
 * to the original lua.c code from the Lua 4.0 interpreter:
 * 	http://www.lua.org/
 * 
 * These changes are documented in lua4.c.diff.  Copyright of the original
 * code is a variant of the zlib license and my changes are under the same
 * copyright.
 * 
 * 	(C) 2000, 2003 Eero Tamminen
 */
/* ------------------------------------------------------------ */
/*
** $Id: wlua4.c,v 1.1 2009-08-29 21:54:15 eero Exp $
